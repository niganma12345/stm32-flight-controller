...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : RH_Pin */
  GPIO_InitStruct.Pin = RH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  HAL_GPIO_Init(RH_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : CSN_Pin LED1_Pin LED2_Pin */
  GPIO_InitStruct.Pin = CSN_Pin|LED1_Pin|LED2_Pin;
